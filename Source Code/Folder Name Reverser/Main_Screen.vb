...
Public Class Main_Screen
    ...
    Private Sub PreCount_Function(ByVal worker As BackgroundWorker)
        Try
            ...
            'Dim backupfolder As String = (dinfo.FullName & "\").Replace("\\", "\") & "RND Backup " & Format(Now, "yyyyMMddHHmmss")
            ...
            For Each finfo As DirectoryInfo In dinfo.GetDirectories
                lastinputline = "Scan Revealed: " & finfo.Name
                inputlinesprecount = inputlinesprecount + 1
                inputlines = inputlines + 1
                worker.ReportProgress(0)
                finfo = Nothing
    ...
    Private Sub backgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        Else
            ...
            If AlertMessage.Length > 0 Then
                ...
                MsgBox("The following folders could not be reversed: " & vbCrLf & AlertMessage, MsgBoxStyle.Information, "Names Reversed")
            End If
        End If
        ...
        Try
            ...
            If dinfo.Exists Then
                ...
                For Each finfo As DirectoryInfo In dinfo.GetDirectories()
                    ...
                    End If
                    Try
                        Dim stringarray As String() = finfo.Name.Split(" ")
                        Dim newname As String = ""
                        For i As Integer = stringarray.Length - 1 To 0 Step -1
                            newname = newname & stringarray(i) & " "
                        Next
                        newname = newname.Trim

                        Try
                            If My.Computer.FileSystem.DirectoryExists((finfo.Parent.FullName & "\" & newname).Replace("\\", "\")) = False Then
                                'MsgBox(finfo.FullName & vbCrLf & (finfo.Parent.FullName & "\" & newname).Replace("\\", "\"))
                                finfo.MoveTo((finfo.Parent.FullName & "\" & newname).Replace("\\", "\"))
                            Else
                                AlertMessage = AlertMessage & finfo.Name & vbCrLf
                            End If
                        Catch ex As Exception
